      ...
      <div class="col-4">
        ...
        <div class="col-6 mx-auto">
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="new-password" wire:model.defer="agregar.password" type="password" placeholder="Password" class="form-control">
                  @error('agregar.password') <span class="text-danger">{{$message}}</span> @enderror
                </div>
                <div class="form-group">
                    <label> Confirmar Password</label>
                    <input autocomplete="new-password" wire:model.defer="confirmar_password" type="password" placeholder="Password" class="form-control">
